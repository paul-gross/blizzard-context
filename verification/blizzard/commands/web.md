...
| File                                         | Read when…                                                                                                                                              |
| -------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [`static-checks.md`](./web/static-checks.md) | …you are running `web:lint`, `web:typecheck`, `web:client-drift`, `web:structural-gate`, or `web:bundle-composition` — the checks that need no browser. |
