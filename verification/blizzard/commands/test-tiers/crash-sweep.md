...
half to eight minutes of wall time on a GitHub runner, under the sweep step's declared `timeout-minutes: 15` ceiling.
Bounded, but not a fast check. The bounded subset is intersected with the live registry and asserts each named point
