...
| [`./commands/web.md`](./commands/web.md)                         | You are verifying the Angular workspace: `web:lint`, `web:typecheck`, `web:client-drift`, `web:structural-gate`, `web:shell-sweep`                                                                      |
| [`./commands/contract-sweeps.md`](./commands/contract-sweeps.md) | You are changing an SSE frame, changing the CLI's command surface, or changing a fact one surface restates from another: `blizzard:sse-contract`, `blizzard:cli-contract`, `blizzard:restatement-sweep` |
