...
| web:shell-sweep            | `npm run shell-sweep` in `web/` — reach for it when a change touches a layout claim jsdom cannot evaluate; a real-Chromium proof (`@vitest/browser-playwright`) whose covered surfaces and per-spec assertions are stated once, [spec by spec](./blizzard/commands.md#webshell-sweep). *(more)*                                                                                                                                                                                                                                                  |
