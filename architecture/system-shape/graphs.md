...
`work-items`, `garden findings`, `garden proposals`, `scope list`, and chunk history — are blizzard's own surface,
identical across every application it drives (`blizzard runner attach` is a deprecated alias for `artifact create` —
