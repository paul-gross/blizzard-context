...
| [./repository-access.md](./repository-access.md)   | Touching persistence, or a controller that reaches it — deciding who may read a store, who may write it, what a domain call takes, or whether a per-id resolution loop or a new read seam needs a plural form |
