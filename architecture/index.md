...
| [./system-shape.md](./system-shape.md)             | Designing a daemon or an external-system seam — the deterministic-shell/intelligent-core split and the pluggable-seam rule, plus the route to the store-schema, runner–worker, and graph rules |
