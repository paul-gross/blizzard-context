...
| [./prose-authoring.md](./prose-authoring.md) | Reviewing or writing a doc/comment change in `blizzard` or `blizzard-mock` — confirms this harness's prose-authoring conventions bind there too, and where each channel binds |
