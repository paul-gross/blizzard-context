...
| A domain concept      | The [`blizzard-context:/domain/`](../domain/index.md) file modeling it, or the delegate spoke `bzh:domain-no-technical-detail` sends a delegated key to                                                                                                                             |
