...
| [exemplars/python/repo_pattern.py](./exemplars/python/repo_pattern.py) | Adding a repository class or extending one — the reference implementation to pattern its seams off                                                                                    |
| [CONTRIBUTING.md](./CONTRIBUTING.md)                                   | Committing to, pushing to, or delivering into this repo, or authoring or reshaping a rule here                                                                                        |
