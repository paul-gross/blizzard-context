...
| [CONTRIBUTING.md](./CONTRIBUTING.md)                                   | Committing to this repo, or authoring a rule here — the authoring conventions and stable-id scheme, commit format, delivery, and the pre-push expectation                             |
